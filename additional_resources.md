...
* [Fixity](https://www.avpreserve.com/products/fixity/)
* [Exactly](https://www.avpreserve.com/products/exactly/)
* [FFmpeg](https://www.ffmpeg.org/)
* [ffmprovisr](https://amiaopensource.github.io/ffmprovisr/)
* [An introduction to using the command line interface to work with files and directories](https://www.avpreserve.com/an-introduction-to-using-the-command-line-interface-to-work-with-files-and-directories/)
* [MediaInfo](https://mediaarea.net/en/MediaInfo)

## Collection Management, Cataloging & Inventorying

* [WITNESS Activists- Guide to Video Archiving](https://archiving.witness.org/archive-guide/)
* [AV Artifact Atlas](https://bavc.github.io/avaa/)
